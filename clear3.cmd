rem Скрипт удаляет временные папки пользователя, кэш IE, пути на последние использованые файлы, кукисы
rem Сетевые пути и принтеры 
rem очищает корзину на диске С
rem WinXP и Win2000 удаляет дистрибутивы обновлений
rem 19/10/2012
rem 15/11/2012
rem 04/03/2013 добавил очиску резервных копий после обновлений на win7 dism /online /cleanup-image /spsuperseded
rem 04/03/2013 в тестовом режиме добавил удаление текущих обновлений и запрос с WSUS новых.
rem 19/06/2013 добавил исправления настроек IE для ХР
rem 12/08/2013 добавил чистку и сжатие файлов cleanmgr.exe 
...
net start wuauserv 
rem удаление архивных файлов, созданных в ходе установки пакета обновления.
...
FOR /F %%A IN ('DIR/B "C:\Documents and Settings"') DO (
	...
	DEL/S/Q/F "C:\Documents and Settings\%%A\NetHood\*.*"
...
rem а вдруг temp не в Windows\Temp ...
